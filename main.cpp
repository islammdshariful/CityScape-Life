...
//GLfloat Car1PositionY = 0.0f;
GLfloat Car1Speed = 0.003f;
//GLboolean StopCar1 = false;
//int KeyZ = 1;
...
void boat1()
{
	...
	//top part
	/*glBegin(GL_QUADS);
	glColor3ub(0, 252, 229);
    glVertex2f( -0.352f, -0.6542f);
    glVertex2f( -0.365f, -0.5744f);
    glVertex2f( -0.672f, -0.5744f);
    glVertex2f( -0.672f, -0.6542f);
    glEnd();*/
...
void boat2()
{
    ...
    /*glBegin(GL_TRIANGLES);
    glColor3ub(192, 220, 193);
    glVertex2f(0.58f, -0.67f);
    glVertex2f(0.624f, -0.4705f);
    glVertex2f(0.67f, -0.66f);
    glEnd();*/
...
void road1()
{
    ...
    //Zebra Crossing////////
    x1 = 0.576f,x2 = 0.573f,x3 = 0.345f,x4 = 0.34f,y1 = -0.1995f,y2 = -0.1596f;//,y3 = -0.1596f,y4 = -0.1995f;
    GLfloat y = 0.0665f;
    GLfloat cx1 = 0.003f;
    GLfloat cx2 = 0.005f;
...
void building4()
{
    ...
    glVertex2f(-0.566f, 0.61f);
    glVertex2f(-0.504f, 0.61f);
    glVertex2f(-0.504f, 0.55f);
    glEnd();*/
}

void building5()//window 99, 156, 177
{
    glBegin(GL_QUADS);
    glColor3ub(255, 72, 0);
...
void building6()//window 99, 156, 177
{
    glBegin(GL_QUADS);
    glColor3ub(124, 0, 191);//124, 0, 191
...
/*void road2()
{
    glBegin(GL_QUADS);
    glColor3ub(100, 99, 97);
    glVertex2f(0.718f, 0.2261f);
    glVertex2f(0.610f, 0.38f);
    glVertex2f(0.600f, 0.38f);
    glVertex2f(0.568f, 0.2261f);
    glEnd();
}*/
